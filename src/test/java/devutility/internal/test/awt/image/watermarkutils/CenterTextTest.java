package devutility.internal.test.awt.image.watermarkutils;
...
public class CenterTextTest extends BaseTest {
	...
	private void test(String sourceImagePath) {
		...
		try {
			WatermarkUtils.centerText(image, "Hello world!", new Font(null, Font.BOLD, 26), Color.BLACK, 0.5f, imagePath);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
