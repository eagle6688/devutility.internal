package devutility.internal.basic.awt.geom;
...
public class RotationTest extends BaseTest {
	...
	public static void main(String[] args) {
		TestExecutor.run(RotationTest.class);
	}

	public static class RotationPane extends JPanel {
		private static final long serialVersionUID = 5780104747813063277L;
		...
		public RotationPane() {
			try {
				img = ImageIO.read(new File("E:\\Downloads\\Test\\Rotation.jpg"));
