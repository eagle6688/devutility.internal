...
public class SlopeTextTest extends BaseTest {
    @Override
    public void run() {
    ...
    private void test(String sourceImagePath) {
        ...
        try {
            WatermarkUtils.slopeText(image, new Font(null, Font.BOLD, 46), Color.BLACK, 0.3f, "Hello World", 8, 120f, imagePath);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void main(String[] args) {
        TestExecutor.run(SlopeTextTest.class);
    }
}
